...
{
  flake.nixosModules.hyprland = {hostName, pkgs, ...}: {
...
# Programms
        ...
        exec-once = [
          "udiskie"
            "waybar" 
            "swww-daemon"
            "swww img /etc/nixos/nonNix/wallpapers/miku.png"
            "swaync"
...
#background
            "$mainMod SHIFT, G, exec, swww img /etc/nixos/nonNix/wallpapers/miku.gif"
            "$mainMod CTRL, G, exec, swww img /etc/nixos/nonNix/wallpapers/miku.png"
